      ...
      <div className="hidden md:flex bg-green-200  flex-col md:flex-row justify-between items-center px-4 py-2 font-semibold ">
        ...
        <div>
          <ul className="flex  md:flex-row flex-col justify-center items-center gap-5 md:gap-20">
            <li>
              <Link href="/" className="border border-white px-2 py-1 rounded-md hover:bg-white">
                Dashboard
              </Link>
            </li>
            <li>
              <Link href="/set-budget" className="border border-white px-2 py-1 rounded-md hover:bg-white">
                Set Budget
              </Link>
            </li>
            <li>
              <Link href="/expense-insights" className="border border-white px-2 py-1 rounded-md hover:bg-white">
                Expense Insights
              </Link>
            </li>
          </ul>
      ...
      <div>
        <div className="md:hidden ">
          <div className="bg-green-200 flex  items-center text-center">
            ...
            <Link href="/" className="ml-2 text-base  font-bold">
          ...
          <ul
            ...
            } duration-1000 absolute text-black menu-sm ml-2 z-[1] p-2 bg-green-200 space-y-5 w-44 py-4 rounded-sm border border-green-500`}
          >
            <li>
              <Link href="/" className="border border-white px-2 py-1 rounded-md hover:bg-white">
                Dashboard
